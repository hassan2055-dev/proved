  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              What You Get with Every ProveNcheck Report
            </h2>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 text-white text-center">
            <h3 className="text-2xl font-bold mb-4">ProveNcheck Service Guarantee</h3>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Since 2020, ProveNcheck has expanded to over 35 international markets. We pull data from comprehensive databases, including national vehicle registries, insurance records, law enforcement, and government agencies.
            </p>
          </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="text-blue-600">support@provencheck.site</div>
            ...
            <div className="bg-blue-50 p-8 rounded-lg">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="text-blue-600">provencheck.site</div>
                </div>
                <div>
      ...
      <div className="sr-only">
        ...
        <p>Keywords: ProveNcheck, proven check, vehicle history report, VIN check, car history, auto history report, used car report, vehicle records, accident history, mileage verification, title check, car buying, automotive history, vehicle inspection, vin reports, car reports, auto reports</p>
      </div>
