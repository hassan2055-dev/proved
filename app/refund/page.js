          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                ...
                <li><strong>Request Method:</strong> Email support@provencheck.site with your request</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                <li><strong>Contact us within 14 days:</strong> Email support@provencheck.site</li>
