            ...
            <section>
              ...
              <div className="bg-blue-50 p-6 rounded-lg mb-6">
                <div className="text-gray-700">
                  ...
                  <p className="mb-2"><strong>Website:</strong> <Link href="https://provencheck.site" className="text-blue-600 hover:text-blue-700">https://provencheck.site</Link></p>
                  <p className="mb-2"><strong>Email:</strong> support@provencheck.site</p>
                </div>
              </div>
              <p className="text-gray-700 leading-relaxed">
                CarCheck is the company operating the ProveNcheck vehicle history report service. All services are provided by CarCheck under these Terms of Service.
              </p>
            </section>
