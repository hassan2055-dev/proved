...
export const metadata = {
  title: "About ProveNcheck - Professional Vehicle History Reports | Company Information",
            ...
            <div className="bg-blue-50 p-8 rounded-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-blue-600">provencheck.site</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ProveNcheck provides professional vehicle history report services to help customers make informed car buying decisions.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Contact ProveNcheck</h2>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="text-gray-600">support@provencheck.site</div>
                </div>
                <div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="text-gray-600">provencheck.site</div>
                </div>
                <div>
