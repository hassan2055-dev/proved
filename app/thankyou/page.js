      ...
      <main className="flex items-center justify-center min-h-[calc(100vh-4rem)] px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Your ProveNcheck VIN report request has been successfully submitted and payment has been processed. Your comprehensive vehicle history report will be delivered soon. For any query feel free to message us on support@provencheck.site
          </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start text-left">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Our ProveNcheck system is now processing your VIN and gathering data from comprehensive databases worldwide.</p>
                </div>
              </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button 
              onClick={() => window.location.href = 'mailto:support@provencheck.site'}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">support@provencheck.site</p>
            </div>
